#ifndef KYOTODD_ZDD_CLASS_H
#define KYOTODD_ZDD_CLASS_H

// Included by bdd_types.h. Declares the ZDD class. Pull in the umbrella
// header first so the types, constants, DDBase, and Memo classes that
// ZDD depends on are already visible.
